...
function ADD(num,subtitle,title,string,url,ard)
{
    const a=document.querySelector('#new')
    a.innerHTML+=`
    <div class="card">
    <div class="card-img-top">
      <img class="img-fluid" style="width:100%; height:170px;" src="${ard}">
    </div>
    <div class="card-text">
...
const addMovieHandler = () => {
  ...
  const ardValue= userInputs[5].value;
  ...
  if (
    ...
    alert('Please enter valid values (樣式 1 to 5)');
    return;
  }
  ...
  toggleBackdrop();
  clearMovieInput();
  ADD(numValue,subtitleValue,titleValue,ratingValue,imageUrlValue,ardValue);
  updateUI();
};
